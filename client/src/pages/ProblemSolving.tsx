    ...
    <div className="container mx-auto px-4 py-8 max-w-5xl h-[calc(100vh-64px)] overflow-hidden flex flex-col">
      <div className="mb-6 flex items-center gap-3 shrink-0 px-2">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-heading font-bold">Problem-Solving Q&A</h1>
          <p className="text-muted-foreground">Ask questions, share answers, and earn Problem-Solver Points</p>
        </div>
