  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-5xl h-[calc(100vh-64px)] overflow-hidden flex flex-col">
      <div className="mb-6 flex items-center gap-3 shrink-0 px-2">
        ...
        <div>
          <h1 className="text-3xl font-heading font-bold">Discover People</h1>
          <p className="text-muted-foreground">Find and connect with students, teachers, and industry professionals</p>
        </div>
      </div>
